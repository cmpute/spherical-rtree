...
class Tree:
    ...
    """
    def __init__(self, points: List[List[float]], values: Optional[List[int]]) -> None: ...
    def __len__(self) -> int: ...
    def __getitem__(self, index: int) -> Tuple[float, float, float, int]: ...
    def initialize(self, origin: Tuple[float, float, float], max_distance: Optional[float]) -> None: ...
